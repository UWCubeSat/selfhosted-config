...
<server xmlns="urn:jboss:domain:16.0">
    ...
    <profile>
        ...
        <subsystem xmlns="urn:jboss:domain:keycloak-server:1.1">
            ...
            <spi name="hostname">
                ...
                <provider name="default" enabled="true">
                    <properties>
                        <property name="frontendUrl" value="https://m4_getenv_req(DOMAIN_CURRENT)/keycloak"/>
    ...
    <interfaces>
        ...
        <interface name="public">
            <inet-address value="${jboss.bind.address:m4_getenv_req(WIREGUARD_NATHAN_IP)}"/>
        </interface>
    </interfaces>
    <socket-binding-group name="standard-sockets" default-interface="public" port-offset="${jboss.socket.binding.port-offset:0}">
        <socket-binding name="http" port="${jboss.http.port:m4_getenv_req(KEYCLOAK_PORT)}"/>
